...
void *EthHeader::get_raw() { return (void *) raw; }

void EthHeader::set_raw(void *raw) { this->raw = (struct ether_header *) raw; }
...
uint32_t EthHeader::get_header_len() { return 14; }
...
void EthHeader::get_bitstring_header(std::vector<std::string> &to_fill)
{
    ...
    v.push_back(std::make_tuple("eth_dhost", 48));  v.push_back(std::make_tuple("eth_shost", 48));
